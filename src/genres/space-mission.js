...
export function create(level, api) {
  ...
  function moonHud() {
    ...
    else if (phase === "flight") mid = "ALT " + (fl.y / 1000).toFixed(1) + " km · V " + Math.round(Math.hypot(fl.vx, fl.vy)) + " m/s" + (fl.thrusting ? " · POUSSÉE/BURN" : "") + " · ESPACE/SPACE thrust/poussée · ←→ steer/gouverne";
